...
const images = [
  ...
  {src:"images/forest1/2.2.png", text:"They march towards the village gate, the path ahead uncertain but unavoidable.", sound:"sounds/path-walk.mp3"},
  {src:"images/forest1/2.3.png", text:"Faye – I guess there’s no turning back now…", sound:"sounds/owl.mp3"},
  {src:"images/forest1/2.4.png", text:"Charging ahead, the group prepare to confront the Vampire Lord in his castle. ", sound:"sounds/rustling.mp3"}
];
